...
RNN_ADAM = 'RNN_ADAM_model=RNN_optimizer=ADAM_initial_lr=0.0001_batch_size=20_seq_len=35_hidden_size=1500_num_layers=2_dp_keep_prob=0.35_save_best_0'
...
dirs = [RNN_ADAM, GRU_SGD_LR, TX_SGD_LR]
labels = ['RNN_ADAM', 'GRU_SGD_LR', 'TX_SGD_LR']
